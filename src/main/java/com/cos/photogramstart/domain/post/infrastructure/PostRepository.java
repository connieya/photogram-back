...
import com.cos.photogramstart.domain.post.infrastructure.querydsl.PostRepositoryQuertdsl;
...
public interface PostRepository extends JpaRepository<Post, Long> , PostRepositoryQuertdsl {
